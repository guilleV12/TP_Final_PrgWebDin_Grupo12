        ...
        <div class="row mb-3">
                <div class="col-sm-6 ">
                    <div class="form-group has-feedback">
                        ...
                        <input id="idcompraestado" name="idcompraestado" type="text" readonly value="<?php echo count($listaCET) ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<table id="dg" title="Lista de Compras" class="easyui-datagrid" style="width:800px;height:400px" url="listar.php" singleSelect="true">
        <thead>
        <tr>
...
<a href="javascript:void(0)" class="easyui-linkbutton" id="editarusuariorol" iconCls="icon-add" plain="true" onclick="c()">Confirmar </a>
